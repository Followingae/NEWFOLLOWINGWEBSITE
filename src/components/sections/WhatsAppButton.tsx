...
export function WhatsAppButton({
  number = "1234567890",
  message = "Hey Following, I'd like to discuss a project.",
}: WhatsAppButtonProps) {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center shadow-lg transition-shadow duration-300 hover:shadow-xl"
