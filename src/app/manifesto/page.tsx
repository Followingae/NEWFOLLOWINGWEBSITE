          ...
          {manifestoBlocks.map((block, i) => (
            <div key={i}>
              ...
              {(i === 0 || i === 2 || i === 4) && (
                <BlurFade inView>
                  <div
                    className="relative flex aspect-[21/9] items-center justify-center overflow-hidden rounded-xl"
                    style={{
                      background: i === 0
                  ...
                  >
                    <div className="text-center">
                      ...
                      <p className="text-xs font-semibold uppercase tracking-wider text-white/30">
                        {i === 0 ? "TEAM IN ACTION" : i === 2 ? "BEHIND THE SCENES" : "THE FOLLOWING WAY"}
                      </p>
                    </div>
                  </div>
                </BlurFade>
        ...
        <Container>
          <BlurFade inView>
            <div className="text-center">
              ...
              >
                <NumberCounter
                  value={manifestoStats.startValue}
                  suffix="+"
                />
              </p>
            </div>
